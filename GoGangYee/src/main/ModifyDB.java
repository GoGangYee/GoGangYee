...
public class ModifyDB extends JFrame{
      ...
      void showWest() {
         ...
         JRadioButton rdo1 = new JRadioButton("ppm", true);
      ...
      void showEast() {
         ...
         // p1.setBorder(new TitledBorder(new LineBorder(Color.AQUA, 1),"입력"));
         ...
         p1.setBorder(BorderFactory.createEmptyBorder(70,180,50,180));
         p2.setBorder(BorderFactory.createEmptyBorder(70,180,50,180));
