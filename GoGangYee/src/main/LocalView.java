...
public class LocalView extends JFrame{
	 LocalView(){
		 ...
		 JRadioButton no2=new JRadioButton("이산화질소");
		 no2.setFont(new Font("맑은고딕",Font.BOLD,13));
		 JRadioButton ozone=new JRadioButton("오존");
		 ozone.setFont(new Font("맑은고딕",Font.BOLD,13));
		 JRadioButton co2=new JRadioButton("이산화탄소");
		 co2.setFont(new Font("맑은고딕",Font.BOLD,13));
		 JRadioButton so2=new JRadioButton("아황산가스");
		 so2.setFont(new Font("맑은고딕",Font.BOLD,13));
		 ...
		 finedust.setFont(new Font("맑은고딕",Font.BOLD,13));
		 JRadioButton ultrafinedust=new JRadioButton("초미세먼지");
		 ultrafinedust.setFont(new Font("맑은고딕",Font.BOLD,13));
